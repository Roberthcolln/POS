...
class ProdukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $barcodeData = $generator->getBarcode($request->nama_produk, $generator::TYPE_CODE_128);
        $barcodeFileName = 'barcode_' . time() . '.png';
        file_put_contents(public_path('file/barcodes/' . $barcodeFileName), $barcodeData);
        ...
        $produk->barcode = $barcodeFileName; // Simpan barcode ke database
        $produk->save();
